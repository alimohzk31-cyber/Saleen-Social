...
export default function AddServiceModal({ onClose, initialCategorySlug, onSaved }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center items-start sm:items-center p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
      <div className={`w-full max-w-md border rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 my-auto bg-[var(--surface-elevated)] border-[var(--border)]`}>
